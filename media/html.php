...
class JDocumentHTML extends JDocument
{
	...
	/**
	 * Get the contents of the templatetemplatebuffer
	 *
	 * @return  mixed|string The contents of the templatebuffer
	 *
	 * @since   3
	 */
	...
	/**
	 * Set the contents of the templatebuffer
	 *
	 * @param   string  $template  The content to be set in the templatebuffer.
	 *
	 * @return  void
	 *
	 * @since   3
